...
# install screenfetch
cd
wget https://raw.githubusercontent.com/kholizsivoi/script/master/master.zip
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/kholizsivoi/script/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
